...
<details className="mb-1 -mt-2">
  <summary className="text-gray-200 text-[15px] mb-2">Majority: Server Components</summary>
...
<details className="mb-1 [&[open]]:mb-4 [&[open]]:border-b [&[open]]:border-gray-100">
  <summary className="text-gray-200 text-[15px] mb-2">Occasionally: React `use` + Context</summary>
...
<details className="space-y-6">
  <summary className="text-gray-200 text-[15px] mb-2">Why Tailwind?</summary>
